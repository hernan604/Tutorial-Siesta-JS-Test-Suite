...
Lembre-se: No final tudo é software e softwares tem bugs. E quanto mais testes melhor e provavelmente menos bugs aparecerão.
...
Por exemplo, um teste para provar que o método de somar e multiplicar funcionam:
  ...
  ok( somar( 1 , 2 )    == 3, ' soma de 1 com 2 resulta em 3 ' ) #1+2 tem que ser igual a 3
  ok( somar( 92 , 50 )  == 142, ' soma de 92 com 50 resulta em 142 ' )
  ok( somar( 100 , 2 )  == 102, ' soma de 100 com 2 resulta em 102 ' )

  ok( multiplicar( 100 , 2 )  == 200, ' 100 vezes 2 tem que dar 200 ' )
  ok( multiplicar( 200 , 3 )  == 600, ' 200 vezes 3 tem que dar 600 ' )

  ok( dividir( 200 , 2 )  == 100, ' 200 vezes 3 tem que dar 600 ' )

ou ainda, juntar vários métodos, ex:
  
  ok( ( somar( 1, 2 )   *   multiplicar(   subtrair( 2,1 )  ,   20 ) ) == 60 , " tem que resultar em 60 "  )
...
e se por acaso resultar num false, o teste vai falhar, por exemplo:
  ...
  ok( somar( 2 , 2 ) == 3, ' soma de 1 com 2 resulta em 3 ' ) # Este teste vai falhar pois 2+2 != 3
